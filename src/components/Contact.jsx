...
const Contact = () => {
  return (
    <div id="contact" className="my-10 min-h-96 w-screen px-4 sm:my-20 sm:px-10">
      <div className="relative overflow-hidden rounded-lg bg-black py-16 text-[#f5efe6] sm:py-24">
        {/* Ambient brand glows */}
        <div className="pointer-events-none absolute -left-24 -top-24 h-72 w-72 rounded-full bg-[#e8a33d]/20 blur-[120px]" />
        <div className="pointer-events-none absolute -bottom-24 -right-24 h-72 w-72 rounded-full bg-[#e8a33d]/15 blur-[120px]" />
        ...
        <div className="relative flex flex-col items-center text-center">
            ...
            <Button
              ...
              onClick={() => {
                window.location.href =
                  "mailto:contact@kingpinvisionforge.com?subject=Project enquiry";
              }}
          ...
          <div className="relative z-10 mt-10 flex flex-col items-center gap-4 sm:flex-row sm:gap-8">
            <a
              ...
              className="flex items-center gap-2 font-general text-sm text-[#f5efe6]/60 transition-colors hover:text-white"
