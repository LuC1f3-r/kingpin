      ...
      <motion.div className="fixed inset-0 z-0" style={{ y: backgroundY }}>
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <motion.div
            ...
            style={{
              background:
                "radial-gradient(ellipse, rgba(34, 197, 94, 0.4) 0%, rgba(59, 130, 246, 0.3) 40%, transparent 70%)",
              filter: "blur(40px)",
            }}
            animate={{
              x: [0, 50, -30, 0],
          ...
          <motion.div
            ...
            style={{
              background:
                "radial-gradient(ellipse, rgba(168, 85, 247, 0.4) 0%, rgba(236, 72, 153, 0.3) 40%, transparent 70%)",
              filter: "blur(35px)",
            }}
            animate={{
              x: [0, -40, 60, 0],
          ...
          <motion.div
            ...
            style={{
              background:
                "radial-gradient(ellipse, rgba(6, 182, 212, 0.4) 0%, rgba(99, 102, 241, 0.3) 40%, transparent 70%)",
              filter: "blur(45px)",
            }}
            animate={{
              x: [0, 30, -50, 0],
        ...
        <div className="max-w-2xl mx-auto text-center">
            ...
            >
              <div className="bg-emerald-500/20 border border-emerald-400/30 rounded-lg p-4 flex items-center justify-center space-x-3">
                ...
                <span className="text-emerald-300 font-medium">
                  Welcome to the future! We'll be in touch soon.
                </span>
              </div>
            </motion.div>
          )}
          ...
          >
            <form onSubmit={handleSubmit} className="max-w-md mx-auto">
              <div className="flex bg-[#0f111a]/80 backdrop-blur-md border border-white/10 rounded-full overflow-hidden shadow-[inset_0_0_10px_rgba(255,255,255,0.1)]">
                <input
                  type="email"
                  value={email}
                  ...
                  required
                  className="flex-1 px-5 py-3 bg-transparent text-white placeholder-white/60 focus:outline-none text-sm"
                />
                <button
                  type="submit"
                  disabled={isSubmitted}
                  className="px-6 py-3 bg-white text-black font-semibold disabled:bg-gray-300 transition-all duration-300 text-sm rounded-r-full"
                >
          ...
          <motion.div
            ...
            className="mb-10"
          >
            <p className="text-sm md:text-lg text-gray-500 font-light leading-relaxed max-w-lg mx-auto">
